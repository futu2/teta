...
/** Identifier for one query scope in the public IR. */
export type ScopeId = string;
/** Name of a recursive CTE generated by a frontend or renderer. */
export type InternalCteName = string;
/** Name of an intermediate CTE generated by the renderer. */
export type GeneratedCteName = string;
